      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
           ...
           <li class="hvr-underline-reveal active"><a href="/resume.php">Resume<span class="sr-only"></span></a></li>
...
<div class="container" style="padding: 0px;">
    ...
    <div class="text-box">
        <!-- <p>Click <a href="resources/Resume.pdf">Here</a> For The PDF Version.</p> -->
        <?php 
            echo shell_exec("cat /var/www/html/resources/resume.md | markdown");
        ?>
    </div>
